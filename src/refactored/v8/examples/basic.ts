...
async function main() {
  ...
  console.log(higgsfieldSoul.schema());
  // ============================================
  ...
  const { video: captionedVideo } = await generateCaptionedVideo({
    model: ffmpeg,
