/**
 * VARG SDK - Basic Example
 *
 * This example matches the exact style from the user prompt.
 *
 * Usage:
 *   npx ts-node examples/sdk_prototype_ts/basic.ts
 */

import { fal, higgsfield, elevenlabs } from './providers';
import {
  generateImage,
  animateImage,
  generateSpeech,
