/**
 * Basic Example - matches the user's original TypeScript example
 */
...
async function main() {
  // ==========================================================================
  // Model Definitions (exactly as in user's example)
  // ==========================================================================
  ...
  const lypsync = fal.lipsync('fal-ai/sync-lipsync/v2/pro')

  // ==========================================================================
  // Prompts (exactly as in user's example)
  // ==========================================================================
  ...
  // ==========================================================================
  // Pipeline (exactly as in user's example)
  // ==========================================================================
  ...
  const { audio: speech } = await generateSpeech({
    model: elevenLabs,
  ...
  console.log('Generated speech:', speech.url)
  ...
  console.log('Final lipsynced video:', lipsyncedVideo.url)
}
