 ...
 *   Scene 1: VEED lipsync talking head  (segment 0)
 *   Scene 2: image b-roll + voiceover   (segment 1 as clip child)
 *   Scene 3: VEED lipsync talking head   (segment 2)
 *
 * Tests the `children: string[]` -> `.segments` feature.
 * One ElevenLabs API call; segments are ResolvedElement<"speech">.
 *
...
// --- Scene 1: lipsync talking head with segment 0 ---
...
// --- Scene 3: lipsync talking head with segment 2 ---
...
const demo = (
  <Render width={1080} height={1920}>
    ...
    {/* Scene 2: banana b-roll + segment voiceover as clip child */}
