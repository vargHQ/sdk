...
export function helpCommand() {
  ...
  content.push(`  ${c.cyan("find".padEnd(12))}fuzzy search for models/actions`);
  content.push(
  ...
  content.push(`  ${c.dim("REPLICATE_API_TOKEN".padEnd(24))}replicate api key`);
  content.push(`  ${c.dim("ELEVENLABS_API_KEY".padEnd(24))}elevenlabs api key`);
